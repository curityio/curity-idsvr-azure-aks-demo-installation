...
######################################################################
# A script to create some self signed certificates for the aks deployment
######################################################################
...
#
ROOT_CERT_FILE_PREFIX='example.aks.ca'
ROOT_CERT_DESCRIPTION='Self Signed CA for example.aks'
SSL_CERT_FILE_PREFIX='example.aks.ssl'
WILDCARD_DOMAIN_NAME='*.example.aks'
